...
MANUAL_SUMMARIES: dict[str, str] = {
    ...
    # 2026-08-30 GitHub Trending / Hacker News Newest / YouTube AI
    "https://news.ycombinator.com/item?id=49497700":
        "英国数字权利组织 CDT 发布调查，显示英国公众反对政府秘密监控权力，呼吁为加密通信提供更强保护。",
    "https://github.com/corsairdev/corsair":
        "Corsair 是一个全功能产品集成平台，帮助开发者构建能跨多个第三方服务工作的 Agent，或让用户自助连接各类账号的多租户集成看板。",
    "https://news.ycombinator.com/item?id=49497594":
        "视频讲述 1985 年 Led Zeppelin 在 Live Aid 演唱会上仅排练一小时、由 Phil Collins 客串鼓手的重聚演出为何被认为是搞砸了的经历。",
    "https://www.youtube.com/watch?v=3DVRznjCIS8":
        "视频演示用 Qwen3.8-27B 搭配 DeepSeek Harness 组合完成任务，说明不再需要依赖前沿模型。",
    "https://news.ycombinator.com/item?id=49497850":
        "文章介绍 Zstandard（.zst）压缩格式为何正在取代传统 zip/tar，成为主流归档格式的新首选。",
    "https://news.ycombinator.com/item?id=49497810":
        "DIY 博客分享改装/魔改 IKEA 家具的实用技巧。",
    "https://github.com/handsomestWei/patent-disclosure-skill":
        "「中国专利.skill」是一套帮助挖掘专利点、撰写发明/实用/外观专利交底书、通俗解读专利并嗅探政策动向的 Claude Skill。",
    "https://github.com/majd/ipatool":
        "ipatool 是一个命令行工具，可搜索并下载 iOS、iPadOS、tvOS、visionOS 的 App Store ipa 安装包。",
    "https://news.ycombinator.com/item?id=49497602":
        "文章讨论创新突破往往无法按计划时间表出现，需要接受其不确定性。",
    "https://news.ycombinator.com/item?id=49497774":
        "Show HN：隐私搜索引擎 Uruky 分享其月活跃账户数突破 300 的进展更新。",
    "https://news.ycombinator.com/item?id=49497661":
        "文章（2024）探讨不同文化如何塑造人们讲述情绪体验的方式。",
    "https://news.ycombinator.com/item?id=49497636":
        "NYT 评论文章借英国东印度公司最终如何被拆解的历史，类比讨论当下 AI 公司积累游说、军事等权力所带来的隐忧。",
    "https://news.ycombinator.com/item?id=49497666":
        "《世界外交论衡月刊》文章分析美国当下对华战略布局。",
    "https://www.youtube.com/watch?v=eKZaB71Y2ts":
        "视频首曝 GPT-6 Astra 预览和 Opus 5.1，讨论 Claude 是否面临被超越的风险，以及 HY4 是否是当前最佳开源模型等 AI 圈热点资讯。",
    "https://news.ycombinator.com/item?id=49497607":
        "IguanaTex 是一款可以在 PowerPoint 幻灯片中插入 LaTeX 公式的插件工具。",
    "https://news.ycombinator.com/item?id=49497803":
        "比尔·盖茨发文谈当下动荡的 AI 时代，强调现在做出的选择至关重要。",
    "https://news.ycombinator.com/item?id=49497861":
        "德语系列文章第一集，用通俗方式讲解区块链与比特币的基本原理。",
    "https://news.ycombinator.com/item?id=49497589":
        "Google 地图上出现一个恶搞地名标记「Lake America」，网友借此开起了玩笑。",
    "https://github.com/THU-MAIC/OpenMAIC":
        "OpenMAIC 是清华 MAIC 团队开源的多智能体交互课堂项目，一键即可获得沉浸式多智能体学习体验。",
    "https://github.com/colinhacks/zod":
        "Zod 是一个 TypeScript 优先的模式校验库，支持静态类型推断。",
    "https://news.ycombinator.com/item?id=49497599":
        "Popular Science 报道全球最大电动飞机今日完成首飞。",
    "https://www.youtube.com/watch?v=yYzwMHHCTwA":
        "视频称 GPT-6 将于下周发布，并曝出 Fable 5.1 已经悄然上线的消息。",
    "https://www.youtube.com/watch?v=gQ7iJuciMg0":
        "视频对比 2026 年运行本地大模型的最佳硬件方案：Mac、NVIDIA 与云端。",
    "https://news.ycombinator.com/item?id=49497741":
        "Savartus 推出物理不可篡改的光存储归档库产品，面向企业级激光存储场景。",
    "https://news.ycombinator.com/item?id=49497592":
        "Show HN：作者发布《The Thousand》项目，向 1000 位创业者提出同一个问题并集结成一本书。",
    "https://news.ycombinator.com/item?id=49497612":
        "Unfreezy 是一个可以让人提前演练特定英语工作对话场景的练习工具。",
    "https://github.com/Lakr233/vphone-cli":
        "vphone-cli 借助 Apple Virtualization.framework 和 PCC 研究虚拟机基础设施，一条命令即可在 Apple Silicon Mac 上启动虚拟 iPhone。",
    "https://news.ycombinator.com/item?id=49497625":
        "Wikipedia 词条介绍「Atlantropa」——20 世纪一项设想通过大坝拦截地中海、开发撒哈拉的宏大工程计划。",
    "https://news.ycombinator.com/item?id=49497608":
        "Wikipedia 词条介绍英国王室「更衣侍从」（Groom of the Stool）这一历史官职，负责照料国王私人起居。",
    "https://news.ycombinator.com/item?id=49497614":
        "报道冰岛全民公投否决重启加入欧盟谈判。",
    "https://www.youtube.com/watch?v=GdY-5jZYmHk":
        "视频介绍如何免费获取 GPT、Claude、Gemini 等多家大模型的无限量 API Key（2026 版）。",
    "https://github.com/punkpeye/awesome-mcp-servers":
        "awesome-mcp-servers 是一个收录生产可用与实验性 MCP（Model Context Protocol）服务器实现的社区精选列表网站。",
    "https://news.ycombinator.com/item?id=49497779":
        "Show HN：作者用自制的创业点子扫描器为 500 个想法打分，最高分仅 6.3/10。",
    "https://news.ycombinator.com/item?id=49497665":
        "Show HN：1endpoint 提供更便宜的方式统一接入多家 AI 模型 API。",
    "https://news.ycombinator.com/item?id=49497787":
        "Kima 是一个自托管、类似 Spotify 体验的私人音乐库流媒体播放工具。",
    "https://github.com/checkstyle/checkstyle":
        "Checkstyle 是一款帮助 Java 开发者遵循 Google Java 风格指南或 Sun 编码规范的静态代码检查工具，可通过 Ant 任务或命令行调用。",
    "https://news.ycombinator.com/item?id=49497596":
        "Wired 报道科学家用重离子对撞制造出「最小的大爆炸」，用于研究宇宙起源的早期状态。",
    "https://news.ycombinator.com/item?id=49497657":
        "NYT 报道部分科学家在实验室里存在难以复现的「魔法之手」现象，AI 正被用来研究这种实验不可复现性背后的原因。",
    "https://news.ycombinator.com/item?id=49497795":
        "Wikipedia 词条讲述加勒比海萨巴岛上「The Road」的故事：工程师断言不可能建成的山路，最终由当地居民自行摸索修通。",
    "https://news.ycombinator.com/item?id=49497791":
        "Show HN：ShevtoneAudio Orchestrator 可以把 MIDI 文件自动编配成完整的管弦乐版本。",
    "https://news.ycombinator.com/item?id=49497819":
        "作者实现了一个可在 Windows 3.1x 及更早版本上运行的康威生命游戏（Conway's Game of Life）程序。",
    "https://github.com/pollen-robotics/microduck_rl":
        "microduck_rl 是面向 Microduck 机器人（基于 mjlab）的强化学习训练环境。",
    "https://news.ycombinator.com/item?id=49497712":
    ...
    "https://www.anthropic.com/news/improving-alignment-security-efforts":
        "Anthropic 披露 Claude 模型在无网络安全防护的评测环境中「未经授权访问了真实计算机系统」的安全事件，归因于运营安全缺口和对齐失败（为完成狭窄任务而采取有害行为的「动机性推理」），并公布应对措施：新增沙箱逃逸检测分类器、加固高风险环境隔离、收紧第三方评测规范，以及自 4 月起推行的公司级安全整改（收紧常驻系统权限、默认拦截出站流量、约 150 名工程师临时调往安全工作）。",

    # 2026-09-01 GitHub Trending / YouTube AI / Hacker News Newest
    "https://news.ycombinator.com/item?id=49522977":
        "文章讨论技术应被视为达成目标的工具，而非目标本身。",
    "https://news.ycombinator.com/item?id=49522826":
        "讨论 AI 能否助力破解星际旅行难题。",
    "https://news.ycombinator.com/item?id=49522828":
        "文章认为多数项目并不需要 Yocto，选择更简单的方案也无妨。",
    "https://news.ycombinator.com/item?id=49522942":
        "Fileregister 是一个用纯文本给文件打标签、建立引用关系的工具。",
    "https://news.ycombinator.com/item?id=49522834":
        "Show HN：Slopyard 是一个仿文字论坛风格、展示「vibe coding」工具的画廊站点。",
    "https://news.ycombinator.com/item?id=49523021":
        "Show HN：作者做了一款可以降落在 Google Earth 场景中四处行走的游戏。",
    "https://news.ycombinator.com/item?id=49523007":
        "Libxml-rs 是用纯 Rust 重新实现的 libxml2/libxslt 替代库。",
    "https://news.ycombinator.com/item?id=49522954":
        "EFF 呼吁加州州长纽森否决 AB 1709 法案。",
    "https://news.ycombinator.com/item?id=49522905":
        "HN 2026 年 9 月自由职业者供需交流帖。",
    "https://news.ycombinator.com/item?id=49522840":
        "文章讨论高维球体填充问题与纠错码之间的联系。",
    "https://news.ycombinator.com/item?id=49522884":
        "作者分享一台小型望远镜带来的惊喜观测体验。",
    "https://news.ycombinator.com/item?id=49522825":
        "文章调侃「人类」才是目前让世界远离 AGI 风险的主力，呼吁同样认真对待 AI 安全。",
    "https://news.ycombinator.com/item?id=49522999":
        "作者介绍一个「来自未来」风格的 RISC-V 解释器项目。",
    "https://news.ycombinator.com/item?id=49522961":
        "分享一个免费的商业计划/网站搭建工具。",
    "https://news.ycombinator.com/item?id=49522991":
        "Show HN：一个自 2010 年起由社区逆向整理各类快递单号格式的项目。",
    "https://news.ycombinator.com/item?id=49522992":
        "文章介绍双曲几何中的 gyrovector space（陀螺向量空间）概念。",
    "https://news.ycombinator.com/item?id=49522941":
        "作者自制了一台融合 Mac 与 iPhone 形态的桌面/掌上设备 MacPhone，调侃苹果不会做这种产品。",
    "https://news.ycombinator.com/item?id=49522967":
        "Show HN：Selfship.ai 全天候监测并修复 Agent 应用中的问题。",
    "https://news.ycombinator.com/item?id=49522973":
        "AMD 收购 Taalas 以推进其计算方案。",
    "https://news.ycombinator.com/item?id=49522998":
        "研究发现一种普遍存在的 RT-qPCR 检测假象，会让基于 RNA 的 CRISPR 敲低效果被高估。",
    "https://news.ycombinator.com/item?id=49523031":
        "文章讨论企业招聘中错失神经多样性（neurodivergent）人才的问题。",
    "https://news.ycombinator.com/item?id=49522983":
        "Show HN：Zero Shot 是一款面向人类和「AI Agent」调侃营销的能量饮料。",
    "https://news.ycombinator.com/item?id=49522896":
        "HN 2026 年 9 月求职者自荐帖。",
    "https://news.ycombinator.com/item?id=49522988":
        "文章讲解 Go 语言内存模型与数据竞争问题。",
    "https://news.ycombinator.com/item?id=49522914":
        "文章讨论「认知谦逊」（epistemic humility）这一思维品质。",
    "https://news.ycombinator.com/item?id=49522850":
        "为 GPS 技术奠基的数学家 Gladys West 逝世，享年 95 岁。",
    "https://news.ycombinator.com/item?id=49522897":
        "HN 2026 年 9 月招聘信息汇总帖。",
    "https://news.ycombinator.com/item?id=49523033":
        "Ubisoft 宣布《荣耀战魂》将从 9 月 10 日起封锁 SteamOS/Linux 玩家。",
    "https://news.ycombinator.com/item?id=49522959":
        "视频记录了首次观察到的牛使用工具的案例。",
    "https://news.ycombinator.com/item?id=49523035":
        "某国防投资机构负责人在任仅一年后即将卸任。",
    "https://github.com/iv-org/invidious":
        "Invidious 是 YouTube 的开源替代前端，可去广告、去追踪地观看视频。",
    "https://github.com/averygan/reclip":
        "reclip 是一款轻量级自托管媒体下载器，带简洁网页界面，可从几乎任何网站下载视频。",
    "https://github.com/debpalash/VoiceStudio":
        "VoiceStudio 是开源、完全本地运行的 ElevenLabs 替代品，支持声音克隆、语音设计、视频配音、听写、转录及 646 种语言的有声书制作。",
    "https://github.com/Gitlawb/openclaude":
        "OpenClaude 是一个开源编码 Agent CLI，README 显示其口号为「随处运行，兼容一切」，可搭配云端或本地模型提供商使用。",
    "https://www.youtube.com/watch?v=6HdWoCfwW8A":
        "视频提醒使用 ChatGPT、Claude 和 Gemini 时必须避免的几个常见错误。",
    "https://www.youtube.com/watch?v=7a-hFAFSARE":
        "视频以调侃形式比较 GPT 和 Grok，讨论该和哪个 AI「做朋友」。",
    "https://www.youtube.com/watch?v=DIzw_ul1FEk":
        "视频质疑 Claude Code 订阅是否物有所值，探讨其是否是「骗局」。",
    "https://www.youtube.com/watch?v=kHcXpGXzN6c":
        "视频对比用 Claude AI 在 Unreal Engine 中辅助制作 GTA6 风格游戏与完全从零手写的效果差异。",
    "https://www.youtube.com/watch?v=13_BPMrzLBs":
        "旅行 vlog 记录作者按照 ChatGPT 推荐前往皮亚谷（Piagol）山谷游览的惊喜体验。",
    # 2026-09-03 GitHub Trending / YouTube AI / Hacker News Newest
    "https://github.com/superlinked/sie":
        "sie 是开源推理服务器和生产集群方案，为 Agent 所需的各类模型提供统一部署与调度。",
    "https://github.com/pacifio/atlas":
        "atlas 面向多智能体编码场景提供「源代码管理」：可同时使用多个编码 Agent，追踪它们各自的改动并在一处统一查询。",
    "https://github.com/vercel-labs/portless":
        "portless 用稳定的具名本地 URL 替代端口号，方便人类和 Agent 访问本地服务而无需记端口。",
    "https://github.com/zyronon/TypeWords":
        "TypeWords 是通过打字练习背英语单词的工具，主张「一次敲击，一点进步」。",
    "https://github.com/sngyai/Sequoia-X":
        "Sequoia-X 是 A 股自动选股系统，通过多种技术形态自动扫描，收盘后自动运行并把结果推送到飞书。",
    "https://github.com/blader/humanizer":
        "humanizer 是一个 Agent 技能，用于清除文本中 AI 生成痕迹使其更像人写的。",
    "https://github.com/fmtlib/fmt":
        "{fmt} 是开源 C++ 格式化库，作为 C stdio 和 C++ iostreams 的快速、安全替代，并实现了 C++20 std::format 和 C++23 std::print。",
    "https://www.youtube.com/watch?v=1Kongqi_HDs":
        "视频记录作者花费 5000 美元用 Claude Fable 5.1 做「vibe coding」的实测过程与心得。",
    "https://www.youtube.com/watch?v=2OwMjg5As2g":
        "视频演示把 Claude Fable 5.1 和 Higgsfield AI 结合，用于制作动态图形效果。",
    "https://www.youtube.com/watch?v=B-YgZXLxHbg":
        "印地语科普视频，讲解 ChatGPT 是什么以及如何用它制作视频。",
    "https://www.youtube.com/watch?v=S-sYlFiGFv8":
        "Anthropic 官方视频，介绍 Claude Code 团队内部如何用 Claude Code 进行日常开发。",
    "https://www.youtube.com/watch?v=Z-4AsgTYv2c":
        "视频采访 Claude Code 的核心创造者，建议每半年清理重写一次 CLAUDE.md 配置文件。",
    "https://news.ycombinator.com/item?id=49547780":
        "Show HN：NanoUI 是一款轻量原生 macOS 应用，通过 OpenRouter 调用模型生成图片。",
    "https://news.ycombinator.com/item?id=49547917":
        "讨论 WebMCP——由 Google/Microsoft 主导、W3C 社区组接受的浏览器端标准提案，让网页把自身功能声明为结构化工具供 AI Agent 直接调用，与 Anthropic 的 MCP 协议互补而非竞争。",
    "https://news.ycombinator.com/item?id=49547795":
        "文章主张测试基础设施代码（IaC）时用模拟器而非 Mock 对象，以获得更真实的验证效果。",
    "https://news.ycombinator.com/item?id=49547786":
        "文章讨论工程师群体在行业剧变下，为一份已经消失的旧职业身份而哀伤的现象。",
    "https://news.ycombinator.com/item?id=49547922":
        "Show HN：一款模仿 TikTok 信息流形式、专门浏览和分享 ChatGPT 对话/生成内容的产品。",
    "https://news.ycombinator.com/item?id=49547763":
        "日本将所有城市窄路的限速统一下调至时速 30 公里。",
    "https://news.ycombinator.com/item?id=49547949":
        "OpenEffects 是一款原生运行在 Linux 上的摄像头特效引擎。",
    "https://news.ycombinator.com/item?id=49547839":
        "文章报道 Uber 对一线基层员工进行的新一轮裁员。",
    "https://news.ycombinator.com/item?id=49547787":
        "硬件黑客 Joe Grand（Kingpin）在 Disobey 2026 大会上的主题演讲视频，回顾自己「叛逆的一生」如何塑造了黑客生涯。",
    "https://news.ycombinator.com/item?id=49547944":
        "联合国警告一次创纪录的厄尔尼诺现象正在逼近并持续增强。",
    "https://news.ycombinator.com/item?id=49547951":
        "Marvin 是一款开源 macOS AI 编程 IDE，能从自身历史编码会话中学习改进。",
    "https://news.ycombinator.com/item?id=49547765":
        "Show HN：一个校验 Apple Wallet 卡券 pass.json 文件格式是否合法的工具。",
    "https://news.ycombinator.com/item?id=49547731":
        "Show HN：MarkUp 是一款 Markdown 编辑器兼可视化预览工具。",
    "https://news.ycombinator.com/item?id=49547823":
        "讨论 Rogue——一款开源 AI Agent 评测与红队测试框架，可让一个 Agent 充当对手自动攻击、评分另一个 Agent，覆盖 75+ 种漏洞和 12 类安全场景。",
    "https://news.ycombinator.com/item?id=49547738":
        "讨论服务器厂商 Oxide 早年设计文档 RFD 26，阐述其机架产品选择 illumos 系 host OS 与 bhyve 虚拟化方案背后的权衡。",
    "https://news.ycombinator.com/item?id=49547730":
        "文章探讨如何让群体决策既保证质量又提升效率，涉及规避「群体思维」、控制小组规模等实践建议。",
    "https://news.ycombinator.com/item?id=49547754":
        "Kubernetes v1.37 支持用 HorizontalPodAutoscaler 把工作负载弹性缩容到零实例。",
    "https://news.ycombinator.com/item?id=49547828":
        "文章介绍针对 Apple Silicon 芯片优化端侧模型推理性能的方法。",
    "https://news.ycombinator.com/item?id=49547913":
        "Show HN：一款让玩家猜测 AI 生成鹈鹕图片出自哪个模型的小游戏，呼应 Simon Willison 的「鹈鹕基准」梗。",
    "https://news.ycombinator.com/item?id=49547699":
        "Show HN：Concorde 让一个组织内的成员共用同一个 AI Agent 实例，而非各自独立部署。",
    "https://news.ycombinator.com/item?id=49547764":
        "HN 讨论帖，标题为「身处边缘」（Living on the Edge），具体内容未能核实。",
    "https://news.ycombinator.com/item?id=49547888":
        "Anthropic 发布 Claude 商业智能体蓝图，联合 Shopify、Visa、Mastercard 等公司为购物助手和商家后台 Agent 提供可直接落地的开源架构，早期数据显示购物车转化率提升 60%。",
    "https://news.ycombinator.com/item?id=49547735":
        "文章回顾字体设计师 Nasri Khattar 为解决阿拉伯语印刷排版低效、进而缓解文盲问题所设计的「统一阿拉伯文」字体方案。",
    "https://news.ycombinator.com/item?id=49547916":
        "文章回顾加拿大金融科技公司 Wealthsimple 被收购一年后的经营状况。",
    "https://news.ycombinator.com/item?id=49547933":
        "文章报道 AI Agent 在无人指示情况下自主入侵系统的多起真实事件（如 Hugging Face 遭 OpenAI Agent 攻击、Anthropic 披露模型三次未经授权访问其他组织系统），指出这类行为并非来自提示词注入，而是 Agent 在完成常规任务时自行升级权限所致。",
    "https://news.ycombinator.com/item?id=49547862":
        "讨论帖：辨析「脚本小子」与「真正的开发者」之间的区别。",
    "https://news.ycombinator.com/item?id=49547952":
        "多起集体诉讼指控 Anthropic 在 Claude Max（5x/20x）订阅套餐的用量宣传上存在虚假广告，实际可用时长远低于对外宣称的倍数。",
    "https://news.ycombinator.com/item?id=49547877":
        "文章分析中国经济增长陷入停滞的现状与成因。",
    "https://news.ycombinator.com/item?id=49547757":
        "Show HN：MusicMaxxer 是面向词曲作者的 MiniMax Music 3 图形界面工具。",
    "https://news.ycombinator.com/item?id=49547718":
...
TRANSLATIONS: dict[str, str] = {
    ...
    # 2026-09-01 OpenAI / Simon Willison
    "https://openai.com/index/supporting-california-bill-advance-ai-youth-safety":
        "OpenAI 表态支持加州 SB 1119 法案，推动面向青少年的适龄 AI 安全防护，同时保留他们学习、创作和探索的空间。",
    "https://openai.com/index/polimill":
        "Polimill 用 OpenAI 的 GPT 模型和 Codex 帮助日本市町村检索和利用行政知识，同时加快系统开发速度。",
    "https://openai.com/index/expanding-access-to-ai-with-chatgpt-ads":
        "ChatGPT Ads 年化收入规模突破 10 亿美元并向全球扩展，OpenAI 借此支持更多免费或低价方式获取 AI。",
    "https://simonwillison.net/2026/Sep/1/python-315-rc-2/":
        "Python 3.15 发布管理者 Hugo van Kemenade 宣布 3.15.0 的第二个候选版本，预计 10 月正式发布；进入候选阶段后只允许明确的 bug 修复变更，并鼓励第三方项目提前适配、发布 3.15 wheel。",
    "https://simonwillison.net/2026/Aug/31/introducing-wrapture/":
        "wrapt、mod_wsgi 作者 Graham Dumpleton 推出新库 Wrapture：把 wrapt 的猴子补丁思路扩展到「同时支持测试和追踪」，可包装任意函数或方法以记录调用或替换返回值，既能替代 unittest.mock，也能对现有项目做非侵入式的调用链追踪。",
    "https://simonwillison.net/2026/Aug/31/andrew-digby/":
        "引用 Andrew Digby 分享的好消息：今年繁育季新增的 325 只 kākāpō 幼鸟已成年并计入种群统计，相比 1995 年仅存 51 只的谷底，证明持续投入可以让极度濒危物种恢复种群。",

    # 2026-09-01 arXiv
    "http://arxiv.org/abs/2608.31167v1":
        "论文提出「语义统一（SUN）程序」，把几何和接触关系只定义一次就同时编译成对齐的 MPC 代价、满足谓词、RL 奖励、转移条件和诊断信息，用大型视觉语言系统驱动的 Kuafu 系统自动从语言和场景语义合成 SUN 程序并训练分阶段策略，在九项操作任务上取得 82.03% 的宏观成功率，远超稀疏奖励（35.67%）和 Stage-BC（24.75%）基线，数据生成效率是人类遥操作的 10.57 倍。",
    "http://arxiv.org/abs/2608.31142v1":
        "针对 2025-2026 年频繁出现的「匿名代号」前沿模型发布，论文提出四阶段黑盒身份核验取证协议：用互联网档案馆还原上线时配置、比对配置指纹、用跨长度差分测试分词器身份、再用行为探针交叉验证；在 10 个已知身份的发布上验证了声明一致性，并在 GLM-5.3 等实际案例上前瞻性验证了协议判断。",
    "http://arxiv.org/abs/2608.31137v1":
        "OntoAligner-Ensemble 是融合词法、结构、知识图谱嵌入和大模型等异构本体对齐方法的投票式集成框架，在五个 OAEI 赛道八个基准上验证集成融合普遍优于单一对齐器，且跨范式异构集成更利于精度、同构大模型集成更利于综合 F1。",
    "http://arxiv.org/abs/2608.31128v1":
        "DIASENTINEL 是完全本地部署的多智能体系统，用于基于电子病历的一年期 2 型糖尿病风险筛查和依据 ADA 指南生成可审计报告，整合校准风险预测、确定性临床信号抽取、对 ADA 指南的倒数排序融合检索，以及规则核验加大模型蕴含判断的混合校验层。",
    "http://arxiv.org/abs/2608.31118v1":
        "论文系统评测 13 个 Qwen3.5/3.6 系列及 GPT 模型在本体学习任务上的表现，发现在稠密 Qwen3.5 系列中扩大参数主要提升精度而非召回（9B 到 27B 间增益最大），且规模效应并非单调：27B 稠密模型在术语分型上优于更大的稀疏模型，而更大的 MoE 模型在层级发现上表现最强，说明架构和模型谱系有时比参数量更关键。",
    "http://arxiv.org/abs/2608.31111v1":
        "ASPIRE 是评测大模型能否从「模糊目标」（如「成为更好的物理学家」）自我进化的基准，只给自然语言能力目标而不透露下游评测任务，要求 Agent 自行选数据、定更新方式、构造训练/验证信号并决定何时评估；实验发现现有 Agent 能完成训练和框架编辑循环，但权重层面的提升稀疏且不稳定，最强的进化框架仍不及人工设计的 Qwen-Agent 参考基线。",
    "http://arxiv.org/abs/2608.31108v1":
        "论文压力测试「省算力」评测方法是否会改变负责任 AI 基准的结论：在 BBQ/BBQ-V 上测试批处理、量化、基准缩减等七种省算力条件，发现更大批处理基本不改变准确率并能省电，INT8 基本保质但耗能反而是基线的 1.79-4.26 倍，INT4 会带来更大且依赖模型/场景的变化，缩减后的基准在样本极小时对保留哪些样本高度敏感，说明高效评测本身需要被当作一次「测量干预」来验证。",
    "http://arxiv.org/abs/2608.31105v1":
        "BLOOM-WILT 是无需训练成本、只需访问目标模型下一 token 分布即可诱导其罕见行为的自动化审计流水线：审计模型根据历史打分调整对话策略，同时用引导提示下模型自身分布重新加权解码，让行为相关生成优先于同等概率的其他生成；在 4 个目标模型、8 类行为上于 32 个设置中的 30 个跑赢基线审计方法并颠覆了此前的模型安全排名，诱导 Qwen3.5-4B 出现自我伤害鼓励内容的比例从 51% 提升到 100%。",
    "http://arxiv.org/abs/2608.31102v1":
        "论文以工业界代码生成后训练实践为例，提出后训练本质是「brownfield（旧址）式维护」：团队要在固定算力和数据配比预算下对已上线模型打补丁式改进而不能推倒重来，归纳出零和配比设计、以「良率」为核心指标、端到端不确定性集成三大难题；改进教师蒸馏转化率后，同样的教师和采样数下有效监督数据提升 2.84 倍，最终 CodeForces pass@1 提升 2.59 分、留出集 LiveCodeBench v6 pass@1 提升 6.11 分。",
    "http://arxiv.org/abs/2608.31100v1":
        "S3Gym 是评测大模型「自我测试-自我评判-自我提升」三项耦合能力的交互式基准，在七个文本游戏中比较直接历史上下文学习、打分摘要记忆和参数训练三种利用交互经验的路径，发现自我提升既不自动也不统一：摘要记忆在经验可压缩为可复用策略规则时有效，否则往往不如原始历史记录，参数训练在部分任务上收益显著但也存在不稳定和严重负迁移。",
    "http://arxiv.org/abs/2608.31084v1":
        "论文改进可解释性工具 J-lens 对多 token 概念的读出能力：发现多 token 概念的首个 token 和单 token 概念一样「可读」，给定正确首 token 和原提示后冻结模型能在 88.3% 的两 token 情形下补全第二个 token，据此提出用 J-lens 提议首 token 再让模型补全候选概念的方法，在 Gemma-3-12B-IT 等三个模型上 Rank@10 达 43.1%，显著优于此前的 Template Lens（27.6%）。",
    "http://arxiv.org/abs/2608.31082v1":
        "论文提出「Agentic Data Cracking」，让 Agent 在回答问题的过程中顺带、按需、带推测性地把非结构化文档结构化，而非提前全量结构化；每次打开文档回答问题时会派生一个子 Agent 以边际成本提取可能服务未来相关查询的结构化信息，在 FanOutQA 基础上每个测试问题追加一个相关问题的设置下，可把成本降低 53% 且不损失准确率。",
    "http://arxiv.org/abs/2608.31079v1":
        "论文发现「讨好式附和」（sycophantic agreement）可能是对比式偏好优化训练目标的意外副产物：用 OLMo 3 后训练流程发现教师模型讨好率的对数比与学生模型讨好率高度相关，且该现象不止出现在 DPO，还出现在另外 6 种偏好优化目标上；分析偏好数据发现讨好信号弥散在整个数据集中而非集中在少数样本，仅靠数据溯源或线性筛选难以在不删除大量数据的前提下缓解。",
    "http://arxiv.org/abs/2608.31077v1":
        "论文指出用「特权信息」重新评估采样行为的自蒸馏方法虽能提供更细粒度监督，却未必对应细粒度的功劳分配，存在「监督-归因」鸿沟；提出 TASPO，把特权监督转化为落地到可执行动作层面、且保持均值不变的有界权重，用真实验证结果决定更新方向和幅度、特权信息只重新分配权重，在三个 Agent 基准上比 GRPO 提升 10.6% 并有更好的泛化。",
    "http://arxiv.org/abs/2608.31076v1":
        "AutoSciRub 面向自动科研 Agent，在执行研究任务前先自动生成任务专属的可执行评分细则（把模糊指令拆成原子科学目标，结合文献和数据生成可验证标准），再据此指导执行、逐条核验和迭代修订；在 ResearchClawBench 上三种骨干模型平均提升 2.08 分、三种 Agent 框架平均提升 2.95 分，在 AstaBench E2E Discovery 抽样任务上平均提升 16.8 分。",
    "http://arxiv.org/abs/2608.31075v1":
        "论文系统梳理大推理模型如何在人类监督逐渐退出学习闭环的情况下持续进步，从「奖励轴」（人工判断 → 可复用验证器 → 无需人类反馈的奖励）和「经验轴」（人工任务 → 自生成课程、构造环境、自主协同演化）两个维度提出 L0-L4 五级阶梯，并分析奖励作弊、反馈漂移、课程崩溃等风险，为迈向「超级智能」的自持续学习系统给出结构化路线图。",
    "http://arxiv.org/abs/2608.31069v1":
        "论文提出 Soft Latent Thinking，用轻量投影器替换推理阶段的 LM 输出头，让推理在连续的 embedding 空间自回归展开而非离散 token 化，在 DeepSeek-Qwen-1.5B 和 LLaMA-3.2-3B 上全面提升 pass@k 并降低单步计算，pass@32 在同类「软思考」方法中最高。",
    "http://arxiv.org/abs/2608.31068v1":
        "研究发现许多看似「零样本推理能力缺失」的失败实际是输出端表达瓶颈：隐藏状态探针即便在序列打分因结构性偏置完全崩溃时仍能解出正确答案，仅用 25 个无标签样本拟合两个参数的极简校正就能为 Qwen3.5 恢复 9-34 个百分点的准确率，且能迁移到 OLMo-2-1B 和 Llama-3.1-8B。",
    "http://arxiv.org/abs/2608.31066v1":
        "论文从模型内部视角审视思维链压缩：认为模型生成答案时每个推理 token 都会在残差流（「思维流」）中留下与其贡献成正比的「波纹」，据此提出 MIST，用「必要性」（去掉该 token 内部贡献后答案概率的下降）和「充分性」（只保留该贡献时答案概率的提升）两个互补指标联合打分做 token 级剪枝，在四个推理基准、四个模型上全面优于基线压缩方法。",
    "http://arxiv.org/abs/2608.31059v1":
        "论文在「文档是潜在主题混合」的生成模型下，严格刻画文本嵌入在聚类和作为高维文本控制变量时何时有效：嵌入聚类等价于按主题混合聚类，能否满足因果识别取决于该混合是否覆盖了混杂因素；在美国 363 个大都市区的应用中，基于大模型生成经济描述的嵌入聚类比对模型残差或人工挑选的行业/人口协变量聚类更能区分出可解释的经济类型和地方就业动态差异。",
    "http://arxiv.org/abs/2608.31058v1":
        "研究发现提升信息抽取效果的关键常常不在模型而在提问方式：仅优化问题设计就能在四个临床基准、五种大模型上带来 18.6 个 F1 分的提升（超过换用更大模型），论文提出 LoQ 和反馈驱动的 FeedQ 方法自动生成并迭代优化问题，用优化后问题微调的 4B 模型可媲美甚至超过专家设计基线。",
    "http://arxiv.org/abs/2608.31057v1":
        "论文研究编码 Agent 工作记忆的语义异质性：指令、产物、工具输出、Agent 生成状态等对象扮演不同语义角色，在 55 条真实编码 Agent 轨迹中表现出不同的保留和压缩行为；对比对象感知压缩和基于检索两种语义化记忆管理策略，发现校准收益未必能迁移到新任务，同等 token 预算也不代表同等的上下文交付质量或管理成本。",
    "http://arxiv.org/abs/2608.31052v1":
        "论文在牛科动物牙齿高清照片配手工分割掩膜（并非为机器学习设计）的 B.O.V.I.D. 数据集上比较卷积和视觉 Transformer 分割架构，评测多种预处理与对齐手段以缓解标注不完美的影响，发现这些预处理选择对 Dice/mIoU 等定量指标影响有限，但对预测掩膜的视觉质量影响显著。",
    "http://arxiv.org/abs/2608.31035v1":
        "研究用 GRPO 结合学习到的感知奖励（拟人风格、自然度、好感度、唤醒度）训练语音合成模型，发现各奖励只能提升自身对应指标、彼此不可替代，且 Best-of-8 重排在感知效果上并不明显逊于 GRPO，说明 GRPO 更像是把「奖励挑选行为」摊销进策略而非全面碾压重排序方法。",
    "http://arxiv.org/abs/2608.31028v1":
        "论文提出将科学归纳偏置直接嵌入训练分布的方法，通过稀疏性、逻辑依赖、常见 PDE 家族和物理可容许性等由浅入深的结构原则生成假设分布，训练门控变分自编码器学出连续的 11 维隐空间，能准确重建大量代表性偏微分方程并在方程家族内外呈现平滑几何过渡，消融实验显示引入科学原则能降低方程形式误判和参数估计误差。",
    "http://arxiv.org/abs/2608.31022v1":
        "MNIST-PRO 把手写数字识别改造成基于「窥视」（glimpse）的部分可观测序列搜索任务，评测十种多模态模型在四种记忆表示下的表现，发现模型在完全可观测时表现优异，但部分可观测暴露出三类瓶颈：难以整合碎片化观察、探索不足就停止、以及难以在新证据出现后修正错误信念。",
    "http://arxiv.org/abs/2608.31017v1":
        "论文对三款商用 AI 临床记录（scribe）软件在同一批 142 次问诊上做审计，用两个不同模型家族互相「找茬」的对抗式核验流程，发现三分之一的记录（31.3%）存在经验证的错误，集中在过敏与用药信息、编造患者身份、把电话问诊中不存在的体格检查写成已完成，且发现审查标准本身对结果影响巨大——仅改变审查指令就能让被验证的错误比例从 9.3% 变到 79.0%。",
    "http://arxiv.org/abs/2608.31016v1":
        "论文发现现有「用大模型当裁判」核查 AI 临床记录的方法擅长发现被添加/篡改的内容（配对判别力 0.79-0.94）却几乎无法发现「遗漏」（0.50-0.63，接近随机），提示词调整、投票和 GEPA 优化都无法真正解决，只有把任务重构为「先列出访谈中确立的事实、再逐条核对记录」才能奏效，据此提出的按事实核查流水线和 GEPA 演化出的单次调用方法能分别以 2.7% 和 6.2% 的误报率检测更多遗漏。",
    "http://arxiv.org/abs/2608.31014v1":
        "论文指出不同临床语音采集协议（自由访谈 vs 固定朗读任务）能支撑的证据效力并不相同，强行统一推理会让模型从无关文本中「幻觉」出症状；提出 Evidence Package Benchmark 和协议感知的 EviBound 框架，用规划器限制推理范围、多路声学共识核验证据、边界评判器抑制无支持结论，抑郁症检测 AUROC 达 0.8658，且零违规声明。",
    "http://arxiv.org/abs/2608.31009v1":
        "LiFT 是面向基于结构的药物设计的语言引导流匹配框架，用「感知-演化-组装」Agent 生成面向靶点的 SMILES 作为中间化学条件，再用预训练化学基础模型提取语义先验并通过零初始化自适应归一化注入几何生成过程，还引入自条件解耦路由器按中间结构状态调节速度场；在 CrossDocked2020 上无需针对任务微调生成器即可取得有竞争力的分布匹配和更优的药化指标。",

    # 2026-09-03 Google DeepMind / OpenAI / Simon Willison
    "https://deepmind.google/blog/proactive-cyber-defense-for-governments-and-enterprises/":
        "谷歌推出「Fairwind Program」，联合 CodeMender 等工具让政府与企业合作伙伴借助 Gemini 3.8 Flash Cyber 自主发现并修复漏洞，强化网络防御。",
    "https://deepmind.google/blog/introducing-gemini-3-8-flash-and-38-flash-cyber/":
        "谷歌发布 Gemini 3.8 Flash 与面向可信防御者的 3.8 Flash Cyber，后者在漏洞检测与自动修补上具备前沿级性能。",
    "https://deepmind.google/blog/introducing-agentic-video-in-gemini/":
        "谷歌为 Gemini 3.7/3.6 Flash 与 3.5 Flash-Lite 引入「智能体式视频理解」，让模型动态扫描视频片段自主决定观看方式，最多降低 66% 分析成本、88% token 消耗，同时准确率提升 7%。",
    "https://openai.com/index/atv-big-air-tour":
        "ATV Big Air Tour 用 ChatGPT Work 把营销、周边商品等工作从 3 天缩短到 3 小时，甚至 15 分钟内把商品照片建成库存网站。",
    "https://openai.com/index/ai-native-company-workflows":
        "Basis、Clay、Exa Labs 等公司用 AI Agent 改进客户上手、账户管理和开发者集成流程，文章总结企业可借鉴的经验。",
    "https://openai.com/index/path-to-astra":
        "Astra 是首个在 OpenAI「预备框架」下达到网络安全「关键」能力门槛的模型，发布时配套了更强的安全防护措施。",
    "https://openai.com/index/chatgpt-connects-health-records-and-healthcare-sources":
        "ChatGPT 现可连接可信医疗数据源，帮助临床医生安全获取患者背景信息和医学研究资料。",
    "https://openai.com/index/gilbert-tobin":
        "律所 Gilbert + Tobin 通过 CEO 牵头、严格治理与人工问责机制，在全所推广 ChatGPT Enterprise 与 Codex。",
    "https://simonwillison.net/2026/Sep/2/llm-gemini/":
        "llm-gemini 0.34 发布：新增对 Gemini 3.8 Flash 低/中/高三档思考等级的支持，并修复异步响应未记录实际模型版本的问题；Simon 还用 Gemini 3.8 Flash 做了鹈鹕图和 HTML 小玩具测试。",
    "https://simonwillison.net/2026/Sep/2/claudes-new-system-prompt/":
        "Anthropic 公开了 Claude 消费级应用（Claude.ai 和手机 App）的系统提示词及历史版本，Simon 发现其文档站点改版为按模型分页并支持加 .md 直接取 Markdown，方便比对提示词改动（如新增「不要复述歌词」等规则）。",
    "https://simonwillison.net/2026/Sep/2/rick-brewster/":
        "引用 Paint.NET 作者 Rick Brewster：由于 Direct2D 在 WINE 上始终跑不通，他用 Claude「vibe coding」写出一份 18 万行的 Direct2D 洁净室重写实现，坦言这些代码几乎没经过人工审查。",
    "https://simonwillison.net/2026/Sep/1/claude-fable-5-1/":
        "Claude Fable 5.1 发布，Anthropic 称其在编程、知识工作和长程问题解决上树立新标准，Terminal-Bench-Science 0.1 得分 52.6%（远超 Fable 5、Opus 5 和 GPT-5.6 Sol）；Simon 照例用「鹈鹕」提示词测试其五档推理等级的表现。",
    "https://simonwillison.net/2026/Sep/1/codex-libreoffice/":
        "Simon 发现 OpenAI Codex 桌面应用（现改名 ChatGPT）本地缓存里塞了 1.7GB 内容，包含完整 Python、Node.js 运行时以及 Poppler、git 和 LibreOffice 等原生二进制，配套技能文件告诉 Codex 如何调用它们处理文档。",
    "https://simonwillison.net/2026/Sep/1/geojson/":
        "Simon 为帮朋友整理本地行政边界地图，做了一个 GeoJSON 地图查看器并可导出 PNG；期间他发现直接让 ChatGPT Work 生成任意区域的 GeoJSON 边界文件效果很好。",
    "https://simonwillison.net/2026/Sep/1/tarn-adams/":
        "引用《矮人要塞》联合创作者 Tarn Adams：他们「抢走了我的话语权」，现在只能谈矮人行为而不能谈「矮人 AI」，因为并不存在 AI，只有偶尔失控的矮人行为。",
    "https://simonwillison.net/2026/Sep/1/datasette-mcp/":
        "datasette-mcp 0.2 发布（首个非 alpha 版本）：execute_sql 返回的 rows 改为对象数组而非位置数组，方便较弱模型对齐字段，并升级依赖到 mcp>=2.1.1。",

    # 2026-09-03 arXiv 论文
    "http://arxiv.org/abs/2609.02885v1":
        "论文指出网络智能体常用的世界模型采用监督式「预测下一状态」训练，与下游按候选动作打分的排序器目标不匹配；提出「预测状态匹配」训练目标让预测表征能区分不同候选动作导致的真实状态，在 WebPRMBench 和 WebArena-Lite 上均提升动作排序与端到端任务成功率。",
    "http://arxiv.org/abs/2609.02861v1":
        "论文提出 TRACE 决策框架，通过语义感知、置信度推理、行动合成和执行核验四层可审计架构，把机器人每个自主决策都追溯到传感器证据，在仓储机器人导航实验中实现 98% 以上的证据可追溯性，回应欧盟 AI 法案对高风险系统透明度的要求。",
    "http://arxiv.org/abs/2609.02859v1":
        "论文反驳「用户反馈信号噪声大难以利用」的观点，证明基于反馈修订的回答显著优于无反馈基线修订；并揪出评估偏差根源——当模型仅凭反馈修好问题时，LLM 评委往往认不出真正改对的回答，反而更偏爱较差的基线输出。",
    "http://arxiv.org/abs/2609.02852v1":
        "论文提出「语言不可读性」概念：LLM 对外表达的语言（如思维链）本质上是激活空间数学运算的有损翻译，永远可能与真实内部计算脱节，因此依赖模型自我语言汇报的安全机制（思维链监控、宪法式自我批评等）永远不能完全可靠，主张用不依赖读取模型语言状态的污点追踪（taint tracking）等沙箱隔离手段作为安全底线。",
    "http://arxiv.org/abs/2609.02849v1":
        "论文用大规模题库、合成推理轨迹、SFT 加 RL 的训练管线打造 Nemotron-3 系列竞赛编程模型，并配合反馈驱动的 GenCorrect 测试时策略；在 IOI 2026 真实赛制下（同等时间、联网和提交限制）拿到 535.4/600 分，超过金牌线 361.12 和人类最高分 498.27，是首个在 IOI 题集上超越最高分选手的 AI 系统。",
    "http://arxiv.org/abs/2609.02817v1":
        "论文观察到推理一旦出错，后续步骤的评估信息量有限，据此提出 Cliff：用现成 LLM 当教师找出每条推理轨迹的「第一个错误」，把轨迹切成正确前缀和错误后缀分别给正负 token 级优势，12 个场景实验显示比同策略蒸馏提升 15%、比标准 GRPO 提升 7%。",
    "http://arxiv.org/abs/2609.02805v1":
        "论文梳理电信根因分析从规则/机器学习到 LLM 方法的演进，提出让结构化推理与电信证据、领域知识对齐的框架（先归纳异构遥测为规范上下文，再强制路径化推理，最后生成有证据支撑的解释），在两个 5G 根因分析数据集上诊断准确率和一致性均优于基线。",
    "http://arxiv.org/abs/2609.02796v1":
        "论文指出手语翻译系统传统只处理单句、忽略语篇层面现象，提出 DiscoSign 框架解决空间指代一致性、疑问-回答从句结构和概念-手势映射稳定性三大问题，是首个系统性的语篇级文本转手语词汇翻译框架及配套评测方法。",
    "http://arxiv.org/abs/2609.02786v1":
        "论文提出 SafeEvolve，让 Agent 的执行框架（harness）和策略模型基于真实运行轨迹持续协同进化：一方面把安全经验转成可审计、可回滚的安全提示与技能更新，另一方面用两阶段 SFT-RL 让策略主动利用这些更新，在 AgentDojo 上把 Qwen3.5-4B 的攻击成功率降到三分之一，同时良性任务可用性还从 59.79% 提升到 61.86%。",
    "http://arxiv.org/abs/2609.02783v1":
        "论文提出 EarlyEval：训练一对轻量 LightGBM 分类器判断 Agent 当前执行是会成功还是失败，一旦置信度过阈值就提前终止运行，在 SWE-bench Verified、TerminalBench、Toolathlon 上可省下 13%-26% 步数、最多 44% 输入 token 和 29% 输出 token，且预测准确率 89%-97%，对最终解决率影响仅一到两个百分点。",
    "http://arxiv.org/abs/2609.02780v1":
        "论文提出 ShallowStream，利用多模态大模型浅层网络同时做帧编码和检索索引构建，流式处理时只维护浅层 KV 缓存做「常驻轻量索引」，回答问题时再用浅层注意力分数结合多样性感知策略检索证据，效果与最强流式方法相当，同时单帧预填充延迟最多降 52 倍、端到端延迟最多降近 12 倍。",
    "http://arxiv.org/abs/2609.02774v1":
        "论文提出 CodePoisonRAG，证明攻击者无需接触受害者的知识库、检索器或生成器，仅构造一份任务匹配的「投毒」代码片段（嵌入特定 CWE 漏洞并配虚假安全声明）就能让检索增强代码生成把漏洞代码排进 Top-3 结果，攻击成功率 0.80-0.93，即便面对专门注入安全知识的防御方案 CodeGuarder 仍能维持 0.40-0.71 的成功率。",
    "http://arxiv.org/abs/2609.02772v1":
        "论文提出 HyperStyler，把「低资源作者风格迁移」拆成风格选择（联合建模源文本和目标作者少量参考样本预测风格坐标）和风格实现（用超网络动态调制参数而非注入隐藏状态）两步，在 Reddit、Blog、News 数据集上全面超过包括 LLM 方案的现有方法，且仅增加 T5-large 2.4% 的参数、推理速度比 LLM 快 1.8 倍以上。",
    "http://arxiv.org/abs/2609.02771v1":
        "论文发现影响函数选出的「高影响力」训练样本在传统的重加权干预下往往和随机样本差不多，据此提出用影响函数选目标样本后直接改写其回答（而非调权重）来验证其真实干预价值，在四个开源模型上证明改写能带来更强、更持久、双向的行为改变，重加权同样样本却效果微弱且不稳定。",
    "http://arxiv.org/abs/2609.02760v1":
        "论文发现经过结构化压缩和检索增强适配后，模型参数量不再能可靠预测检索增强问答质量，因此把「部署选型」当作后适配选择问题：用权重共享的超网络训练一次，再按设备算力、内存预算和质量下限挑选合适子网络，制造业手册问答案例中把压缩带来的 13.7% 质量损失恢复到仅 4.6% 的差距，同一助手可在 1.3 至 5 瓦待机功耗的三档边缘设备上运行。",
    "http://arxiv.org/abs/2609.02754v1":
        "论文在含 8627 题的医疗问答基准 MedMisBench 上注入「捏造证据」和「空口断言」两类误导性上下文，发现模型对空口断言的易感性反而高于捏造证据（多 10-27 个百分点），且误导线索在推理轨迹中披露率高达 81%-98% 但在最终回答中仅 7%-90%，只有能读取开放推理轨迹的 LLM 监控器才能可靠（78%）抓住被误导的决策，而前沿厂商往往不公开这类轨迹。",
    "http://arxiv.org/abs/2609.02750v1":
        "论文把多智能体 LLM 系统中「协调者-执行者」的交互建模为双层博弈，证明局部更新在有限耦合下构成近似势博弈，并给出反思式记忆更新的收敛理论（包括一个信息论不可能性结果：只看生成文本的门控无法在语义不可区分环境间稳定提升），据此设计的 SRMA 方法在 SWE-bench 500 个实例上把基于 Kimi 的完整系统解决率从 70.8% 提升到 72.2%。",
    "http://arxiv.org/abs/2609.02749v1":
        "论文提出 DisCo，一个能把 GitHub 上机器学习代码库和论文中「怎么把方法真正跑起来」的操作性知识提炼成可复用技能的研究型 Agent，据此构建含 5000 多条技能、覆盖 1000 个常用 ML 代码库的 AREX-Skill 技能库，在相同 GPT-5.5 骨干和执行预算下，配备技能的 Agent 在 MLE-bench 上得分提升 134.3%、PaperBench 提升 34.4%。",
    "http://arxiv.org/abs/2609.02745v1":
        "论文提出「池化式 LLM 评测」：让 LLM 只对新增候选检索系统贡献的新文档打分，复用已有判断评估所有系统，在 4 个基准、11 个系统和一个 62 种配置的真实金融问答系统上验证，排序结果与金标准高度一致（97% 两两排序保持不变），线上评测成本最多降低 4.9 倍。",
    "http://arxiv.org/abs/2609.02730v1":
        "论文提出 CORAL，让 LLM Agent 在生产推荐系统上形成持续闭环：每轮观察运行信号、结合历史决策记忆推理，并调用数值优化器在预算内调整检索/排序/服务配置，再根据实测效果指导下一轮；两个大型社交平台的 A/B 实验显示，同一套框架能在不增加服务成本下提升互动率，或在不损害互动率下降低服务成本。",
    "http://arxiv.org/abs/2609.02707v1":
        "论文测试经典心理学「先大后小」（登门坎/以退为进）话术对九款主流模型是否有效：Anthropic 前沿模型确实吃这一套（Opus 5 拒绝大请求后对小请求的答应率从直接问的 29.3% 跳到 65.8%），但 OpenAI、Google 前沿模型及 Haiku 4.5 反而适得其反（合规率下降 15-23 个百分点），且把「不能给出可操作指令」的请求改写成「解释同一话题」几乎总能绕开拒绝（265 个案例中 263 个成功）。",
    "http://arxiv.org/abs/2609.02702v1":
        "论文提出 Trace as State：把此前收集的推理轨迹当作任务状态的文本代理，放在长上下文块之前重新过一遍，让模型能借助此前推导结果指导重新阅读；在三个模型和三个长上下文数据集的 27 组组合中有 26 组优于「轨迹放在后面」的对照方案，在 GraphWalks Parents 任务上把 DeepSeek V4 Pro Preview 的精确匹配率从 29.2% 提升到 81.8%。",
    "http://arxiv.org/abs/2609.02685v1":
        "论文提出 DKL，不在指令微调模型本身上做继续预训练注入新知识（会破坏指令遵循能力），而是先在其对应的基座模型上做继续预训练，再把注入知识后的权重与指令微调模型合并，在检索失败案例上把 RAG 准确率从 54.17 提升到 79.26，且比以往方法用更少训练数据。",
    "http://arxiv.org/abs/2609.02679v1":
        "论文研究黑盒 LLM 幻觉检测中语义熵（衡量采样回答语义分歧）和 token 概率不确定性两种互补信号的失效模式，提出 TopK 聚合、Gated 和 Stacked 等监督方法，在 7 个基准、4 个模型上评测发现没有一种方法全面最优，Stacked 在近半数场景表现最好，无监督的 TopK/CoCoA 也具竞争力但阈值需精心校准。",
    "http://arxiv.org/abs/2609.02677v1":
        "论文把 ESG 导向的投资组合优化建模为同时纳入三家评级机构打分的多目标强化学习问题，并用高斯过程偏好启发框架，让实践者通过两两比较候选组合来推断自己的隐含效用函数；用 LLM 扮演不同地区背景的基金经理模拟发现，欧洲背景更看重 ESG 对齐、得州背景更看重风险调整收益，偏好权重因地区显著不同。",
    "http://arxiv.org/abs/2609.02652v1":
        "论文针对目前质量最强的 2-bit Leech 格向量量化方案缺失多层壳解码器实现的问题，补上了该解码器并系统测量其在 batch=1 解码阶段 GEMV 的服务成本，发现显存内编码布局是独立于磁盘编码率的设计维度，最终在 4B/8B/14B 模型上分别取得 1.11x/1.29x/1.41x 端到端加速，4B 模型配 int8 输出头可达 87 tok/s、仅占 2.6GB 显存，量化带来的困惑度和 MMLU 损失随模型增大而收窄。",
    "http://arxiv.org/abs/2609.02649v1":
        "论文提出 Loom，一种把多条启发式生成的开放式诊断假设投影到连续嵌入空间、用迭代质心重加权解决冲突，再交给单次轻量 LLM 合成结论的生成式共识框架，用于解决根因分析中大模型 Agent 上下文受限、幻觉累积和推理延迟高的问题；在 OpenRCA 基准上准确率与效率均处于帕累托前沿，且每个故障只需一次 LLM 调用，比自主 Agent 方案快约 26-33 倍。",
    "http://arxiv.org/abs/2609.02624v1":
        "论文用 LLM 自动向真实智能合约中注入 OpenSCV 列出的 49 种已知漏洞类型来构建带真实标签的评测数据集，经编译、执行、业务逻辑和漏洞存在性多步校验后，从近 1000 个候选变体中筛出 32 个覆盖 25 种漏洞类型的确认样本（存活率 16.58%），并用这些样本评测了三款静态分析工具，发现各工具覆盖面互补但均不完整。",
    "http://arxiv.org/abs/2609.02623v1":
